...
/**
 * Returns bookable UTC intervals within the supplied business-hour windows.
 *
 * Inputs are deliberately data-only, so callers can compute availability with
 * a consistent snapshot of bookings and a caller-selected time reference.
 */
